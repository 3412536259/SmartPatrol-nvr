...
public:
    ...
    bool downloadRecordFile(DownloadVideoFile& info,DownloadFile& out) override;
...
private:
    ...
    void downloadWorker(const DownloadVideoFile& info, DownloadFile& out);
...
private:
    ...
    std::mutex download_;
    std::atomic_bool running_download{false};
